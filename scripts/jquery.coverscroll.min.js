(function(c) {
    var b = {};
    var a = {init: function(f) {
		
            var g = {minfactor: 20, distribution: 1.5, scalethreshold: 0, staticbelowthreshold: false, titleclass: "itemTitle", selectedclass: "selectedItem", scrollactive: true, step: {limit: 4, width: 8, scale: true}, bendamount: 2, movecallback: function() {/*alert(g.selectedItem);*/
                }, clicked: false};
            b = g;
            var h = false;
            if (f) {
            ...
            return this.each(function() {
                ...
                m.css({position: "absolute", "-webkit-transition": "all 0.5s ease-in-out", "-moz-transition": "all 0.5s ease-in-out", "-o-transition": "all 0.5s ease-in-out", "-ms-transition": "all 0.5s ease-in-out", transition: "all 0.5s ease-in-out"});
            ...
            function d(k, o, v) {
                ...
                var p = {width: 'auto', height: s, top: 0, left: Math.round(k.width() / 2 - s / 2)};
                ...
                for (i = v - 1; i >= 0; i--) {
                    ...
                    var p = {width: 'auto', height: l, top: Math.round(k.height() / g.bendamount - l / g.bendamount), left: r};
                    if (c.browser.msie) {
                        h = true;
            ...
            function e(l, m, j) {
                ...
                if (n = m.attr("title")) {
                    ...
                    if (n = m.find("." + g.titleclass + ":eq(0)")) {
                        ...
                        n.css({position: "absolute", width: (o * 2), "text-align": "center", top: o, left: Math.round(0 - (o / 2))});
                        setTimeout(function() {
                            n.show();
                            g.movecallback.call(this, m);
                        }, 500);
